...
type Acceptor<T extends AstNode> = {
    [P in Exclude<keyof T, keyof AstNode>]: undefined extends T[P] // permet d'extraire undefined des propriétés optionnelles
        ? ToAcceptor<Exclude<T[P], undefined>> | undefined
        : ToAcceptor<T[P]>
} & {
