 ...
 * </p>
 * <ul>
 *   <li>{@link robotScriptModel.impl.AddImpl#getRight <em>Right</em>}</li>
 *   <li>{@link robotScriptModel.impl.AddImpl#getLeft <em>Left</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AddImpl extends MinimalEObjectImpl.Container implements Add {
	...
	public NotificationChain basicSetRight(Arithmetic newRight, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					RobotScriptModelPackage.ADD__RIGHT, oldRight, newRight);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newRight != right) {
			...
			if (right != null)
				msgs = ((InternalEObject) right).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - RobotScriptModelPackage.ADD__RIGHT, null, msgs);
			if (newRight != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, RobotScriptModelPackage.ADD__RIGHT, newRight,
					newRight));
	}
	...
	public NotificationChain basicSetLeft(Arithmetic newLeft, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					RobotScriptModelPackage.ADD__LEFT, oldLeft, newLeft);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newLeft != left) {
			...
			if (left != null)
				msgs = ((InternalEObject) left).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - RobotScriptModelPackage.ADD__LEFT, null, msgs);
			if (newLeft != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, RobotScriptModelPackage.ADD__LEFT, newLeft, newLeft));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case RobotScriptModelPackage.ADD__RIGHT:
			return basicSetRight(null, msgs);
		case RobotScriptModelPackage.ADD__LEFT:
