 ...
 * </p>
 * <ul>
 *   <li>{@link robotScriptModel.impl.IfImpl#getBody <em>Body</em>}</li>
 *   <li>{@link robotScriptModel.impl.IfImpl#getCond <em>Cond</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IfImpl extends MinimalEObjectImpl.Container implements If {
	...
	protected EClass eStaticClass() {
		return RobotScriptModelPackage.Literals.IF;
	}
	...
	public EList<Command> getBody() {
		if (body == null) {
			body = new EObjectContainmentEList<Command>(Command.class, this, RobotScriptModelPackage.IF__BODY);
		}
		return body;
	}
	...
	public NotificationChain basicSetCond(Expression newCond, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					RobotScriptModelPackage.IF__COND, oldCond, newCond);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newCond != cond) {
			...
			if (cond != null)
				msgs = ((InternalEObject) cond).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - RobotScriptModelPackage.IF__COND, null, msgs);
			if (newCond != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, RobotScriptModelPackage.IF__COND, newCond, newCond));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case RobotScriptModelPackage.IF__BODY:
			return ((InternalEList<?>) getBody()).basicRemove(otherEnd, msgs);
		case RobotScriptModelPackage.IF__COND:
