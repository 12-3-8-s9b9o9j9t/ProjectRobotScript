 ...
 * </p>
 * <ul>
 *   <li>{@link robotScriptModel.impl.EntryPointImpl#getFunctions <em>Functions</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EntryPointImpl extends MinimalEObjectImpl.Container implements EntryPoint {
	...
	protected EClass eStaticClass() {
		return RobotScriptModelPackage.Literals.ENTRY_POINT;
	}
	...
	public EList<FunctionDef> getFunctions() {
		if (functions == null) {
			functions = new EObjectContainmentEList<FunctionDef>(FunctionDef.class, this,
					RobotScriptModelPackage.ENTRY_POINT__FUNCTIONS);
		}
		return functions;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case RobotScriptModelPackage.ENTRY_POINT__FUNCTIONS:
