 ...
 * </p>
 * <ul>
 *   <li>{@link robotScriptModel.impl.BlockImpl#getStmts <em>Stmts</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BlockImpl extends MinimalEObjectImpl.Container implements Block {
	...
	protected EClass eStaticClass() {
		return RobotScriptModelPackage.Literals.BLOCK;
	}
	...
	public EList<Statement> getStmts() {
		if (stmts == null) {
			stmts = new EObjectContainmentEList<Statement>(Statement.class, this, RobotScriptModelPackage.BLOCK__STMTS);
		}
		return stmts;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case RobotScriptModelPackage.BLOCK__STMTS:
