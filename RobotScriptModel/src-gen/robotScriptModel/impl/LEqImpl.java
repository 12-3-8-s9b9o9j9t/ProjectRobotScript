 ...
 * </p>
 * <ul>
 *   <li>{@link robotScriptModel.impl.LEqImpl#getRightOp <em>Right Op</em>}</li>
 *   <li>{@link robotScriptModel.impl.LEqImpl#getLeftOp <em>Left Op</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LEqImpl extends MinimalEObjectImpl.Container implements LEq {
	/**
	...
	protected EClass eStaticClass() {
		return RobotScriptModelPackage.Literals.LEQ;
	}
	...
	public NotificationChain basicSetRightOp(Expression newRightOp, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					RobotScriptModelPackage.LEQ__RIGHT_OP, oldRightOp, newRightOp);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newRightOp != rightOp) {
			...
			if (rightOp != null)
				msgs = ((InternalEObject) rightOp).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - RobotScriptModelPackage.LEQ__RIGHT_OP, null, msgs);
			if (newRightOp != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, RobotScriptModelPackage.LEQ__RIGHT_OP, newRightOp,
					newRightOp));
	}
	...
	public NotificationChain basicSetLeftOp(Expression newLeftOp, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					RobotScriptModelPackage.LEQ__LEFT_OP, oldLeftOp, newLeftOp);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newLeftOp != leftOp) {
			...
			if (leftOp != null)
				msgs = ((InternalEObject) leftOp).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - RobotScriptModelPackage.LEQ__LEFT_OP, null, msgs);
			if (newLeftOp != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, RobotScriptModelPackage.LEQ__LEFT_OP, newLeftOp,
					newLeftOp));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case RobotScriptModelPackage.LEQ__RIGHT_OP:
			return basicSetRightOp(null, msgs);
		case RobotScriptModelPackage.LEQ__LEFT_OP:
