 ...
 * </p>
 * <ul>
 *   <li>{@link robotScriptModel.impl.SecondImpl#getPrefix <em>Prefix</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SecondImpl extends MinimalEObjectImpl.Container implements Second {
	...
	protected EClass eStaticClass() {
		return RobotScriptModelPackage.Literals.SECOND;
	}
	...
	public NotificationChain basicSetPrefix(Prefix newPrefix, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					RobotScriptModelPackage.SECOND__PREFIX, oldPrefix, newPrefix);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newPrefix != prefix) {
			...
			if (prefix != null)
				msgs = ((InternalEObject) prefix).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - RobotScriptModelPackage.SECOND__PREFIX, null, msgs);
			if (newPrefix != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, RobotScriptModelPackage.SECOND__PREFIX, newPrefix,
					newPrefix));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case RobotScriptModelPackage.SECOND__PREFIX:
