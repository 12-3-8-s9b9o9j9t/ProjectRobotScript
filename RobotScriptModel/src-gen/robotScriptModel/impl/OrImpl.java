 ...
 * </p>
 * <ul>
 *   <li>{@link robotScriptModel.impl.OrImpl#getExprs <em>Exprs</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OrImpl extends MinimalEObjectImpl.Container implements Or {
	 ...
	 */
	@Override
	public EList<And> getExprs() {
		if (exprs == null) {
			exprs = new EObjectContainmentEList<And>(And.class, this, RobotScriptModelPackage.OR__EXPRS);
		}
		return exprs;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case RobotScriptModelPackage.OR__EXPRS:
	...
	public void eSet(int featureID, Object newValue) {
		...
		case RobotScriptModelPackage.OR__EXPRS:
			getExprs().clear();
			getExprs().addAll((Collection<? extends And>) newValue);
			return;
		}
