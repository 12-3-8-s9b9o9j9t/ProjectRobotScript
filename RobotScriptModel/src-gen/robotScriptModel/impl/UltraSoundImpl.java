...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Ultra Sound</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link robotScriptModel.impl.UltraSoundImpl#getDefvar <em>Defvar</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UltraSoundImpl extends MinimalEObjectImpl.Container implements UltraSound {
	/**
	...
	protected EClass eStaticClass() {
		return RobotScriptModelPackage.Literals.ULTRA_SOUND;
	}
	...
	public EList<Command> getDefvar() {
		if (defvar == null) {
			defvar = new EObjectContainmentEList<Command>(Command.class, this,
					RobotScriptModelPackage.ULTRA_SOUND__DEFVAR);
		}
		return defvar;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case RobotScriptModelPackage.ULTRA_SOUND__DEFVAR:
