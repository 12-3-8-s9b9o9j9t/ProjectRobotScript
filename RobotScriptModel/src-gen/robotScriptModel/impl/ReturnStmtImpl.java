 ...
 * </p>
 * <ul>
 *   <li>{@link robotScriptModel.impl.ReturnStmtImpl#getExpr <em>Expr</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ReturnStmtImpl extends MinimalEObjectImpl.Container implements ReturnStmt {
	...
	protected EClass eStaticClass() {
		return RobotScriptModelPackage.Literals.RETURN_STMT;
	}
	...
	public NotificationChain basicSetExpr(Expression newExpr, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					RobotScriptModelPackage.RETURN_STMT__EXPR, oldExpr, newExpr);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newExpr != expr) {
			...
			if (expr != null)
				msgs = ((InternalEObject) expr).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - RobotScriptModelPackage.RETURN_STMT__EXPR, null, msgs);
			if (newExpr != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, RobotScriptModelPackage.RETURN_STMT__EXPR, newExpr,
					newExpr));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case RobotScriptModelPackage.RETURN_STMT__EXPR:
