 ...
 * </p>
 * <ul>
 *   <li>{@link robotScriptModel.impl.ModelImpl#getCommand <em>Command</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ModelImpl extends MinimalEObjectImpl.Container implements Model {
	...
	protected EClass eStaticClass() {
		return RobotScriptModelPackage.Literals.MODEL;
	}
	...
	public EList<Command> getCommand() {
		if (command == null) {
			command = new EObjectContainmentEList<Command>(Command.class, this, RobotScriptModelPackage.MODEL__COMMAND);
		}
		return command;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case RobotScriptModelPackage.MODEL__COMMAND:
