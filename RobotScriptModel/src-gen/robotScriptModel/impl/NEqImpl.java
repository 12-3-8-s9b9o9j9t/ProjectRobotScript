 ...
 * </p>
 * <ul>
 *   <li>{@link robotScriptModel.impl.NEqImpl#getRightOp <em>Right Op</em>}</li>
 *   <li>{@link robotScriptModel.impl.NEqImpl#getLeftOp <em>Left Op</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NEqImpl extends MinimalEObjectImpl.Container implements NEq {
	/**
	...
	protected EClass eStaticClass() {
		return RobotScriptModelPackage.Literals.NEQ;
	}
	...
	public NotificationChain basicSetRightOp(Expression newRightOp, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					RobotScriptModelPackage.NEQ__RIGHT_OP, oldRightOp, newRightOp);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newRightOp != rightOp) {
			...
			if (rightOp != null)
				msgs = ((InternalEObject) rightOp).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - RobotScriptModelPackage.NEQ__RIGHT_OP, null, msgs);
			if (newRightOp != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, RobotScriptModelPackage.NEQ__RIGHT_OP, newRightOp,
					newRightOp));
	}
	...
	public NotificationChain basicSetLeftOp(Expression newLeftOp, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					RobotScriptModelPackage.NEQ__LEFT_OP, oldLeftOp, newLeftOp);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newLeftOp != leftOp) {
			...
			if (leftOp != null)
				msgs = ((InternalEObject) leftOp).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - RobotScriptModelPackage.NEQ__LEFT_OP, null, msgs);
			if (newLeftOp != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, RobotScriptModelPackage.NEQ__LEFT_OP, newLeftOp,
					newLeftOp));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case RobotScriptModelPackage.NEQ__RIGHT_OP:
			return basicSetRightOp(null, msgs);
		case RobotScriptModelPackage.NEQ__LEFT_OP:
