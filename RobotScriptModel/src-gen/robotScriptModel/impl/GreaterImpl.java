 ...
 * </p>
 * <ul>
 *   <li>{@link robotScriptModel.impl.GreaterImpl#getRightOp <em>Right Op</em>}</li>
 *   <li>{@link robotScriptModel.impl.GreaterImpl#getLeftOp <em>Left Op</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GreaterImpl extends MinimalEObjectImpl.Container implements Greater {
	...
	protected EClass eStaticClass() {
		return RobotScriptModelPackage.Literals.GREATER;
	}
	...
	public NotificationChain basicSetRightOp(Expression newRightOp, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					RobotScriptModelPackage.GREATER__RIGHT_OP, oldRightOp, newRightOp);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newRightOp != rightOp) {
			...
			if (rightOp != null)
				msgs = ((InternalEObject) rightOp).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - RobotScriptModelPackage.GREATER__RIGHT_OP, null, msgs);
			if (newRightOp != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, RobotScriptModelPackage.GREATER__RIGHT_OP, newRightOp,
					newRightOp));
	}
	...
	public NotificationChain basicSetLeftOp(Expression newLeftOp, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					RobotScriptModelPackage.GREATER__LEFT_OP, oldLeftOp, newLeftOp);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newLeftOp != leftOp) {
			...
			if (leftOp != null)
				msgs = ((InternalEObject) leftOp).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - RobotScriptModelPackage.GREATER__LEFT_OP, null, msgs);
			if (newLeftOp != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, RobotScriptModelPackage.GREATER__LEFT_OP, newLeftOp,
					newLeftOp));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case RobotScriptModelPackage.GREATER__RIGHT_OP:
			return basicSetRightOp(null, msgs);
		case RobotScriptModelPackage.GREATER__LEFT_OP:
